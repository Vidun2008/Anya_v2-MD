...
global.botname = process.env.BotName || "Sam" 
global.author = process.env.Author || "@Vidun" 
global.packname = process.env.PackName || "Vidun Dinsara V2 MD" 
global.myweb = process.env.Web || "https://github.com/PikaBotz" 
global.footer = process.env.Footer || "© Vidun's Assistant BOT" 
global.prefa = process.env.Prefix || ['-'] 
global.themeemoji = process.env.ThemeEmoji || "🎐" 
global.ownername = process.env.Owner_Name || "Vidun~Dinsara" 
global.ownernumber = process.env.Owner_Number || "94716088983" 
global.adress = process.env.Continent || "Asia, Sri Lanka, Matara" 
global.timezone = process.env.TimeZone || "Asia/colombo" 
global.instagramId = process.env.Insta || "8.08_only_mine" 
global.email = process.env.Email_Id || "vidundinsara2008@gmail.com" 
...
module.exports = {
  botname: process.env.BotName || "Sam", 
  author: process.env.Author || "@Vidun",
  packname: process.env.PackName || "Vidun Dinsara v2 MD",
  myweb: process.env.Web || "https://github.com/PikaBotz",
  footer: process.env.Footer || "© Vidun's Assistant BOT",
  prefa: process.env.Prefix || ['-'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "Vidun~Dinsara",
  ownernumber: process.env.Owner_Number || "94716088983",
  adress: process.env.Continent || "Asia, Sri lanka, Matara",
  timezone: process.env.TimeZone || "Asia/colombo", 
  instagramId: process.env.Insta || "8.08_only_mine",
  email: process.env.Email_Id || "vidundinsara2008@gmail.com",
  ...
  sessionId: process.env.SESSION_ID || "QzdHbWh_Queen-Anya_RWFA=", 
